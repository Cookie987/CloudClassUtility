Public Class Form1
    ...
    Private Sub 查看日志VToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 查看日志VToolStripMenuItem.Click
        Log += Date.Now + " 查看日志VToolStripMenuItem.Click" + vbCrLf
        FrmLog.MdiParent = Me
        FrmLog.Show()
    End Sub

    Private Sub 导出日志SToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 导出日志SToolStripMenuItem.Click
    ...
    Private Sub 清除日志CToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 清除日志CToolStripMenuItem.Click
