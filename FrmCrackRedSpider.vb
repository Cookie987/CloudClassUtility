Public Class FrmCrackRedSpider
    Private Sub FrmCrackRedSpider_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Log += DateTime.Now + " Start crack RedSpider"
        Log += DateTime.Now + " 1.Stop RedSpider..."
        ...
        Cbx1.Checked = True
        Pi1.Visible = False
        Log += DateTime.Now + " 2.Replace files..."
        Cbx2.Text = "2.替换文件 (0%)"
        Pi2.Visible = True
        ...
        Try
            ...
            Cbx2.Checked = True
            Pi2.Visible = False
            Log += DateTime.Now + " 3.Run final step..."
            Cbx3.Text = "3.完成破解 (0%)"
            Pi3.Visible = True
